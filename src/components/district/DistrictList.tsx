...
//     onSelect 
// }) => {
//     // Handle selection with proper type safety
//     const handleSelect = useCallback((district: NCESDistrictFeatureAttributes) => {
//         console.log('Selecting district:', district.LEAID); // Debug log
//         onSelect(district);
//     }, [onSelect]);
...
// src/components/district/DistrictList.tsx
/**
 * CharacterStrong – DistrictList
 * Focus outline removed from pagination buttons.
 */
/**
 * CharacterStrong – DistrictList
 * Auto-scrolls to top on page change (matches SchoolList).
 */
/**
 * CharacterStrong – DistrictList
 * Scrolls viewport to very top of the list on every page change.
 */
